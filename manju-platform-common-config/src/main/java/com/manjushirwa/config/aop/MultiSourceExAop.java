package com.manjushirwa.config.aop;

import com.manjushirwa.config.annotion.DataSource;
import com.manjushirwa.config.datasource.DSEnum;
import com.manjushirwa.config.datasource.DataSourceContextHolder;
...
public class MultiSourceExAop implements Ordered {
    ...
    @Pointcut(value = "@annotation(com.manjushirwa.config.annotion.DataSource)")
    private void cut() {
